...
<body>
  <div class="wrapper">
    <form action="#" autocomplete="off">
      <input type="text" spellcheck="false" name="original_url" placeholder="Enter your url:" required>
      ...
      if(mysqli_num_rows($sql2) > 0){;
        ?>
          <div class="statistics">
            ...
            ?>
            <span>Total entered links: <span><?php echo end($res) ?></span> & Total clicks: <span><?php echo $total ?></span></span>
  ...
  <div class="popup-box">
  <div class="info-box">This is your shortened link.</div>
  <form action="#" autocomplete="off">
    <label>Here,edit your shorten url</label>
